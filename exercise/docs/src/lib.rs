...
The term is most commonly applied to round, orange-colored squash varieties, though it does not possess a 
scientific definition and may be used in reference to many different squashes of varied appearance.
!*/
...
//! Looking like ![this](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
impl Pumpkin {
    /// A non-reversible action causing destruction
    pub fn smash(self) {}
}
...
/// Constant to be used in [Pumpkin::orangeness]
